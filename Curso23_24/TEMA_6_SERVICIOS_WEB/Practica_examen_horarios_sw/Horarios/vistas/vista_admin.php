<?php 
    ...
    // Vamos a obtener los profesores normales
    $url = DIR_SERV."/obtenerProfesoresNormales";
    ...
    if (isset($obj->no_auth)) {
        session_unset();
        die(error_page("Horarios", "<p>Error: ".$obj->no_auth."</p>"));
        header("Location:index.php");
        exit;
    }

    // Si le da click al botón de ver horario
...
<body>
        ...
        <select name="profesor" id="profesor">
            <?php 
                foreach ($obj->profesores as $tupla) {
                    if ($_POST["profesor"] == $tupla->id_usuario) {
    ...
    <?php 
        if (isset($_POST["btnVerHorario"])) {
            ...
            echo "<h3 class='centrado'>Horario del profesor: <em>$profesor</em></h3>";
