...
<table>
 <tr>
   <td>Real Madrid:</td>
   <td>
   <img src="barrita.png" width='<?php echo($tantoMadrid); ?>' height='20'> <?php echo($tantoMadrid); ?>%
   </td>
 </tr>
 <tr>
   <td>Barcelona:</td>
   <td>
   <img src="barrita.png" width='<?php echo($tantoBarcelona); ?>' height='20'> <?php echo($tantoBarcelona); ?>%
   </td>
 </tr>
 <tr>
   <td>Atlético de Madrid:</td>
   <td>
   <img src="barrita.png" width='<?php echo($tantoAtletico); ?>' height='20'> <?php echo($tantoAtletico); ?>%
   </td>
 </tr>
 <tr>
   <td>Sevilla:</td>
   <td>
   <img src="barrita.png" width='<?php echo($tantoSevilla); ?>' height='20'> <?php echo($tantoSevilla); ?>%
   </td>
 </tr>
</table>